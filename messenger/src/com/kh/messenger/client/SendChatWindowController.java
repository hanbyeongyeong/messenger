...
public class SendChatWindowController implements Initializable{
	...
	public void initialize(URL location, ResourceBundle resources) {
		...
		textSize = 13;
		tfDisplay.setLineSpacing(10); // �ٰ���
		tfDisplay.setTextAlignment(TextAlignment.LEFT); // �ؽ�Ʈ ����
		...
		taMsg.setStyle("-fx-border-color: red;-fx-background-color: white;");
	...
	public void display(String msg) {
		...
		msg = msg + "\n";
		text.setText(msg);
		text.setFont(Font.font("Verdana", FontWeight.BOLD, Double.valueOf(textSize)));
