...
public class MSvr {
	...
	final String HOSTNAME = "192.168.0.130";
	final int PORT = 6001;
	
	// 로긴 Id, client 정보저장
	Hashtable<String,String> connectedIpList= new Hashtable<>();
...
//							if(status) {
//								connectedIpList.put(id, socket.getInetAddress().toString());
//								}
							...
							case REGISTUSER:
							{
								...
								System.out.println("�α�������: "+connectedClientList);
								// 2) 접속자의 전체 친구목록
		...
		protected void notifyLogin(String loginId) {
			...
			List<MemberDTO> friendList = mdao.getFriends(loginId); //���� ģ���� ����� ���
			List<MemberDTO> friendedList = mdao.getFriendedList(loginId); //���� ģ���� ����� ���
			
			List<MemberDTO> finalList = new ArrayList<>();//�ߺ�����
		...
		protected void notifyLogOut(String logOutId) {
			System.out.println("�α׾ƿ��˸� ȣ���!!"+logOutId);
			List<MemberDTO> firendedList = mdao.getFriendedList(logOutId);
			...
			System.out.println("firendedList3"+firendedList);
			System.out.println("connectedClientList3"+connectedClientList);			
			firendedList.stream().forEach(m -> {
